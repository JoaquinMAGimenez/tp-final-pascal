  ...
  if (respuesta := S) then
      ...
      ReadLn(nombre_estancia_a_buscar);
       ...
       if (nombre_estancia_a_buscar = nom_estancia) then
        ELIMINAR: nom_estancia;
        ELIMINAR: apellidoyNombreD;
        ELIMINAR: domicilio;
        ELIMINAR: correo electrónico;
        ELIMINAR: DNI;
        ELIMINAR: numerodecont;
        ELIMINAR: caracteristica;
        ELIMINAR: capacidad_maxima;
        ELIMINAR: tiene_pisina; 
...
PROCEDIMIENTO PREGUNTAR (VAR ARCH:T_ARCHIVO; BUSCADO:INTEGER; VAR POS:LONGINT);
  ...
  if (respuesta := S) then
      ...
      ReadLn(nombre_estancia_a_buscar);
       busqueda_binaria(estancias, limite, nombre_estancia_a_buscar, posi);
       if (nombre_estancia_a_buscar = nom_estancia) then
          ESCRIBIR (nom_estancia);
          ESCRIBIR (apellidoyNombreD);
          ESCRIBIR (domicilio);
          ESCRIBIR (correo electrónico);
          ESCRIBIR ( DNI);
          ESCRIBIR (numerodecont);
          ESCRIBIR (caracteristica);
          ESCRIBIR (capacidad_maxima);
